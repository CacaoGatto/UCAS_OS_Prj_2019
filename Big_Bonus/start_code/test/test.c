...
//struct task_info task3_0 = {(uint32_t)&test_shell, USER_PROCESS};
...
struct task_info task2_11 = {(uint32_t)&lock_task3, USER_PROCESS};
struct task_info task2_12 = {(uint32_t)&lock_task4, USER_PROCESS};
struct task_info task2_13 = {(uint32_t)&lock_task5, USER_PROCESS};
struct task_info *lock_tasks[16] = {&task2_4, &task2_5,&task2_11,&task2_12,&task2_13};
int num_lock_tasks = 5;
