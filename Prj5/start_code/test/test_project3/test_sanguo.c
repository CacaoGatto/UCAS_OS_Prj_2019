...
struct task_info sq_task = {"SunQuan", (uint32_t)&SunQuan, USER_PROCESS, 1};
struct task_info lb_task = {"LiuBei", (uint32_t)&LiuBei, USER_PROCESS, 1};
struct task_info cc_task = {"CaoCao", (uint32_t)&CaoCao, USER_PROCESS, 1};
